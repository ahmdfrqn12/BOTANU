...
#=============
cl = LineClient()
cl.login(tokzn="EnQtcXF8Da5pdHS5nrbb.X3+sw1N25wpytXm08+7rcW.oHRsR1eKTfwLHbiLTd1pp8K9AUxvQ5y//koUEoswbiA=")
cl.loginResult()

ki = LineClient()
ki.login(tokzn="Ent2LGFcmZNDegiuF2R3.C3uxU5NNlVYFHuNw06LZCW.gAs57AujlCOa7HvEgfhCeCWr0PBpne92C+m9lWKdpkU=")
ki.loginResult()

kk = LineClient()
kk.login(tokzn="Enmdi6vfIkGD6hiTvLPe.bXgVtu5kSGoBSNRPtLnC+G.IeOT15L4PCHn579Ykzc7Z3GzekzhB7lgdS6c4UIdr1M=")
kk.loginResult()

kc = LineClient()
kc.login(tokzn="EnVcjCFfspx2Lh5hc4q5.PT0fO6oRxm3RJkmvumHfXq.s/QmelfyO1zlUv0pMDuK0zhMGDm46ZEzyGJV2kzca1U=")
kc.loginResult()

kd = LineClient()
kd.login(tokzn="EnpZRgxumPNViyZAjuYc.SH8QkzJASCCT21I1OyjN+a.Qq/8ORJsiQUb+grqiWXsD2szHnhZrK7HLUxyK9syP10=")
kd.loginResult()

kz = LineClient()
kz.login(tokzn="EnzrBO5iowNMcODTNtm5.Q0OoFYJHaR1Q19cGwwRPHq.DXk28gYLX3GYT4oh//BHWYo9++4Be/4iw/x7MqsOzR0=")
kz.loginResult()

kf = LineClient()
kf.login(tokzn="En1FYtLsqoZFZYFdVTnc.IXqIA67Yp2TOiNIPBdv0la.HD0dzNcX5rfoI7qm6EwlCi88zbim+nSKyxo9w0omhQE=")
kf.loginResult()

kg = LineClient()
kg.login(tokzn="Enx3b3R1eF4vJXzdgUH4.7UpnrSpbBLku34NMQquZja.x4YxKzrZJTYGjSGdwvJswXLrlEMf7dinJfx3jLjKDx0=")
kg.loginResult()

kh = LineClient()
kh.login(tokzn="EnCTNh4MU3Y9lUCy39rf.VhUBCNkLBNBEY+aAw6H0ZW.LpKAP5EFi4Tk46FilKnathQMY6QMsDHd+fIyAMEjVuQ=")
kh.loginResult()

kj = LineClient()
kj.login(tokzn="EnEAedLdibLoONaMGnK6.Zg2BQYNPKl2ksz44ZIytHG.DN8ar+4Il2MgVoaQ2Z53eFn3uUIEhk3iiPEpbwWPfBk=")
kj.loginResult()

kl = LineClient()
kl.login(tokzn="EnutRFKDWhrhTfkmXbo6.lEc1JaEVsI3l5xpWt5mAnG.x3HmElMPxHJz4X7H3hYa8KqEoaiNFIeDfFdRAGtP91Q=")
kl.loginResult()

km = LineClient()
km.login(tokzn="EnVpepsOV5mXyKu0QfZ6.muq18IWfKt5SEgFXA9fxfG.g0jDSEPT2yonBE4Xr9Ois1Se98T1Wyc7Xmt6l3Qf+CY=")
km.loginResult()

kn = LineClient()
kn.login(tokzn="EncsNNIon04D5fsfBLK7./hD97gr5Xe1yxI05XUWpLW.DS9b4TgUIkCkYuRyCHpR3WYlbk7BQYMeJQFgwbyM9kg=")
kn.loginResult()

ko = LineClient()
ko.login(tokzn="EnZbJaYLpeju4gDp6p16.jNAlelBFImiLiQ74z7TQLG.oJ9MFipwshDCwjRTuo4YiP62dvhK4seLO5eswqiok2A=")
ko.loginResult()

kp = LineClient()
kp.login(tokzn="EnLP2RWQwCI5pQiys4E6.JshQn3mNrRt2A6dgNkzFjG.KwxHyEsfNCb1QIj+M/jTMBYuZNgTE7j43498PgkGDq8=")
kp.loginResult()

kq = LineClient()
kq.login(tokzn="EnXAAKwYb7Ypf4msjkIa.O5l+/QmuY6G/wgyx2fh9EG.cK7F5BNAtPBsyNLeJaMEofAxa/PBZINbLUMrYML5BKM=")
kq.loginResult()

kr = LineClient()
kr.login(tokzn="En30RAuEqV3Of0ffNFk7.EOr9BRGLhQ4vTNqpFe1hfW.oCAUGCHiDramWgJlkcdU3tTJODRJEB10Sq4/LXOo7Ec=")
kr.loginResult()

ks = LineClient()
ks.login(tokzn="Enet1M8ZA9Khg7DMeoN5.L1HeXTaxon2Sz1CLgvtfzq.lqwb5ibFWDEIqlis6gNOihSL9fLljv2MR6wYCxOQeMk=")
ks.loginResult()

kt = LineClient()
kt.login(tokzn="Eng8t5wROkreLDTDSfR1.Rp5lRKgcZmlY4wRBeDTpaq.hq5XIi1r1qffuANiD7WmnMiHYKcZ5+5GZSTwOiZPruY=")
kt.loginResult()

sw = LineClient("email","paswod")
sw.log("Auth Tokzn : " + str(sw.authTokzn))
channel11 = LineChannel(sw)
sw.log("Channel Access Tokzn : " + str(channel11.channelAccessTokzn))
...
def command(text):
    pesan = text.lower()
    if pesan.startswith(Setmain["kzyCommand"]):
        cmd = pesan.replace(Setmain["kzyCommand"],"")
    else:
        cmd = "command"
    return cmd

def help():
    kzy = Setmain["kzyCommand"]
    kzy = kzy.title()
    helpMessage = "▬▬▬▬*****▬▬▬▬\n" + \
                  "╔═[ SELFBOT-BY:SADIS ]\n"+\
                  "║👿☈ " + kzy + "Help\n" + \
                  ...
                  "║🔰☈ " + kzy + "Dellvideo「Teks」\n" + \
                  "║🔰☈ " + kzy + "Addstickzr「Teks」\n" + \
                  "║🔰☈ " + kzy + "Dellstickzr「Teks」\n" + \
                  "║🔰☈ " + kzy + "Spamtag:「jumlahnya」\n" + \
                  "║🔰☈ " + kzy + "Spamtag「@」\n" + \
                  "║🔰☈ " + kzy + "Spamcall:「jumlahnya」\n" + \
                  "║🔰☈ " + kzy + "Spamcall\n" + \
                  "║🔰☈ " + kzy + "Ytmp3:「Judul Lagu」\n" + \
                  "║🔰☈ " + kzy + "Ytmp4:「Judul Video」\n" + \
                  "║🔰☈ " + kzy + "Musik「Nama Penyanyi」\n" + \
                  "║🔰☈ " + kzy + "Get-fs「Query」\n" + \
                  "║🔰☈ " + kzy + "Get-line「ID Line」\n" + \
                  "║🔰☈ " + kzy + "Get-apk「Query」\n" + \
                  "║🔰☈ " + kzy + "Get-gif「Query」\n" + \
                  "║🔰☈ " + kzy + "Get-xxx「Query」\n" + \
                  "║🔰☈ " + kzy + "Get-anime「Query」\n" + \
                  ...
                  "║🔰☈ " + kzy + "Get-mp3「Query」\n" + \
                  "║🔰☈ " + kzy + "Get-video「Query」\n" + \
                  "║🔰☈ " + kzy + "Get-bintang「Zodiak」\n" + \
                  "║🔰☈ " + kzy + "Get-zodiak「Zodiak」\n" + \
                  "║🔰☈ " + kzy + "Get-sholat「Nama Kota」\n" + \
                  "║🔰☈ " + kzy + "Get-cuaca「Nama Kota」\n" + \
                  "║🔰☈ " + kzy + "Get-lokasi「Nama Kota」\n" + \
                  "║🔰☈ " + kzy + "Get-lirik「Judul Lagu」\n" + \
                  "║🔰☈ " + kzy + "Get-instagram「User Name」\n" + \
                  "║🔰☈ " + kzy + "Get-date「tgl-bln-thn」\n" + \
                  "╠══[ protect ]\n" + \
                  "║🛡☈ " + kzy + "Notag「on/off」\n" + \
                  "║🛡☈ " + kzy + "Allpro「on/off」\n" + \
                  "║🛡☈ " + kzy + "Protecturl「on/off」\n" + \
                  "║🛡☈ " + kzy + "Protectjoin「on/off」\n" + \
                  "║🛡☈ " + kzy + "Protectkick「on/off」\n" + \
                  "║🛡☈ " + kzy + "Protectinvite「on/off」\n" + \
                  "║🛡☈ " + kzy + "Protectcancel「on/off」\n" + \
                  "║🛡☈ " + kzy + "Antijs「on/off」\n" + \
                  "║🛡☈ " + kzy + "Ghost「on/off」\n" + \
                  "╠══[ Set kickzr ]\n" + \
                  "║😈☈ " + kzy + "Kick「on/off」\n" + \
                  "║😈☈ " + kzy + "Gk「@」\n" + \
                  "║😈☈ " + kzy + "Bk「@」\n" + \
                  "║😈☈ " + kzy + "Sadis *คำสั่งบินกลุ่ม\n" + \
                  "╠══[ Set user ]\n" + \
                  "║🔔☈ " + kzy + "Invite「on/off」\n" + \
                  "║🔔☈ " + kzy + "Stickzr「on/off」\n" + \
                  "║🔔☈ " + kzy + "Unsend「on/off」\n" + \
                  "║🔔☈ " + kzy + "Respontime「on/off」\n" + \
                  "║🔔☈ " + kzy + "Timeline「on/off」\n" + \
                  "║🔔☈ " + kzy + "Contact「on/off」\n" + \
                  "║🔔☈ " + kzy + "Autojoin「on/off」\n" + \
                  "║🔔☈ " + kzy + "Autoadd「on/off」\n" + \
                  "║🔔☈ " + kzy + "Welcome「on/off」\n" + \
                  "║🔔☈ " + kzy + "Autoleave「on/off」\n" + \
                  "║🔔☈ " + kzy + "Jointickzt「on/off」\n" + \
                  "╠══[ Set Admin ]\n" + \
                  "║💀☈ " + kzy + "Self「on/off」\n" + \
                  "║💀☈ " + kzy + "Bot:on\n" + \
                  "║💀☈ " + kzy + "Bot:expell\n" + \
                  ...
                  "╚═[ SELFBOT-BY:SADIS ]\n" + \
                  "▬▬▬▬*****▬▬▬▬\n" + \
                  "\nkztik「 Refresh 」jika sudah habis anu...\n"
    return helpMessage
...
def helpbot():
    ...
    helpMessage1 = "▬▬▬▬*****▬▬▬▬\n" + \
                  ...
                  "║🤖☈ " + kzy + "Set respon:「Text」\n" + \
                  "║🤖☈ " + kzy + "Set leave:「Text」\n" + \
                  "║🤖☈ " + kzy + "Set welcome:「Text」\n" + \
                  "║🤖☈ " + kzy + "Myname:「Nama」\n" + \
                  "║🤖☈ " + kzy + "Gift:「Mid korban」「Jumlah」\n" + \
                  "║🤖☈ " + kzy + "Spam:「Mid korban」「Jumlah」\n" + \
                  "╚═[ SELFBOT-BY:SADIS]\n" + \
                  "▬▬▬▬ஜ۩۞۩ஜ▬▬▬▬\n" + \
                  "\nkztik「 Refresh 」jika sudah habis anu....\n"
    return helpMessage1
...
#==========================================
                ...
                if msg.toType == 2:
                    ...
                    if matched_list == []:
                        random.choice(ABC).sendText(msg.to,"Fuck You")
                        return
                ...
                if msg.toType == 2:
                    ...
                    kicker.sendText(msg.to," Cleanse  is Starting")
                    kicker.sendText(msg.to,"Group Anda Pantas Di Bersihkan.")
                    kicker.sendText(msg.to,"Good Bye (*�*)")
                    targets = []
                    for g in gs.members:
                        if _name in g.displayName:
                            targets.append(g.mid)
